...
@section('title', trans('common.post_create'))
@section('breadcrumb', Breadcrumbs::render('/post/create', $topic))
@section('content')
...
<div class="card box-shadow box-outline box-dark" style="margin-top: 0.75em; margin-bottom: 0.75em;">
    <div class="card-header">
        <i class="fas fa-fw fa-bars"></i><span class="text-success forum-title"> @lang('common.post_create')</span>
        <small class="forum-desc">@lang('common.post_create_subtext')</small>
    </div>
    <div class="card-body inverse-text">
        {{ Form::open(['action' => 'PostsController@store', 'method' => 'POST'])}}
        <input id="topic" name="topic" type="hidden" value="{{$topic->id}}">
                ...
                <div class="form-group row mb-0">
                    <div class="col-12">
                        <div class="btn-group btn-block">
                            {{ Form::button('<i class="fa fa-plus"></i> '.trans('common.post_create'), ['type' => 'submit', 'class' => 'btn btn-success btn-block'] )  }}
