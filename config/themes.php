...
return [
    ...
    */
    ...
    'themes_path' => realpath(base_path('resources/themes')), // eg: base_path('resources/themes')
	...
	*/
    ...
    'default' => env('APP_THEME', 'lethal.board'),
	...
	*/
	...
	'themes' => [
        ...
        'lethal.board' => [
            'extends' => null,
            'views-path' => 'lethal.board',
            'asset-path' => 'themes/lethal.board',
        ],
		/*
		|---------------------------[ Example Structure ]--------------------------
		|
